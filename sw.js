...
const KEEP_LIST = ["css/style.css?v=0739ea85", "drive/js/drive.js?v=2b343ec1", "img/chacoru.png?v=3406529b", "img/drive-icon-180.png?v=cf8bda78", "img/drive-icon-512.png?v=7c78116c", "img/drive-icon-64.png?v=7088d4ae", "img/kojare.png?v=c5b494db", "img/manage-icon-180.png?v=ac18efea", "img/manage-icon-64.png?v=2b8a9145", "img/mine-icon-180.png?v=cbafcd5d", "img/mine-icon-512.png?v=2dbb903e", "img/mine-icon-64.png?v=ea09f133", "img/owner-icon-180.png?v=cbb1087e", "img/owner-icon-512.png?v=7972b6a3", "img/owner-icon-64.png?v=ce05c3fc", "img/shift-icon-180.png?v=ab0bd671", "img/shift-icon-64.png?v=0254ff8c", "img/shift-qr.png?v=3509f79d", "img/t3dining-mark.png?v=c9163364", "img/works-icon-180.png?v=a0ee5b78", "img/works-icon-512.png?v=dddd764f", "img/works-icon-64.png?v=0f9cbed2", "img/works-qr.png?v=facd8cdc", "js/app.js?v=d4aa6f28", "js/config.js?v=ff6863a5", "js/interview.js?v=a0114594", "js/share.js?v=9836d630", "js/shift-sheet.js?v=2b29c50a", "js/storage.js?v=bb1c6a5f", "js/sync.js?v=e5e3ab56", "js/update.js?v=c530219e", "manage/css/admin.css?v=eae657ea", "manage/js/admin.js?v=529077b0", "shift/css/submit.css?v=febebce2", "shift/js/submit.js?v=2a1c5488", "story/css/story.css?v=55f08ac0", "story/js/story.js?v=72d03613"];

 ...
 *
 * ★実物のOCRでは「4,740円」が **「4.740m」** になっていました
 ...
 *
 * ★名前・件数・金額が別々の行に出ます（現金 / 2点 / 57,368円）。
...
function seisanPayRows(lines, から) {
  ...
  /* ★「円の付いた金額が1つも無い」ときは、積み上がった形とは**みなしません。**
       ...
       303,451 / 96,199 … と、ほとんどの円が消えていました）。
 ...
 *     死下,10·QUICPay       ← 名前
 *     [老の他支払明細]      ← ここに割りこむ
 *     1点 / 4.740m / 15,862円 / 電子▽一 / 1点 / 16,764円
 *
  ...
  /* ⑤' 客数の見出しごと崩れた紙
     ...
     ★そこで**列の数**で数えます。「◯単価」の見出しがN個あるなら、
       それより前にある数が 組数・客数 です。**客数はその最後**です。
         ...
         値 = [14, 85, 28,546, 4,701]   見出し = [組単価, 客単価]
